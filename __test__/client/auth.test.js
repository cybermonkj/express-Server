...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Jimmie.Herman',
      password: 'm2bEQv3DluIzoak',
      email: 'Trent7@hotmail.com',
      name: 'Rhonda Kirlin',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 233,
      mobileNo: '(498) 196-6776',
      resetPasswordLink: {},
      loginRetryLimit: 240,
      loginReactiveTime: '2023-05-30T10:15:14.571Z',
      id: '63d68f9a42cb3e1970a3db49'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Eliane.Greenholt',
        'password':'xDiKaubpu_AzNn_',
        'email':'Clara.Walsh6@yahoo.com',
        'name':'Myron O\'Reilly',
        'shippingAddress':[{
          '_id':false,
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Clara.Walsh6@yahoo.com', });
