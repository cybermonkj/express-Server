...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Alisa.Reichel',
      password: 'NJjC4NK7S720ytN',
      email: 'Shane.Johnston@hotmail.com',
      name: 'Amy Parisian PhD',
      shippingAddress: [
        {
          _id: false,
          pincode: 'U.S.',
      ...
      userType: 768,
      mobileNo: '(795) 418-9368',
      resetPasswordLink: {},
      loginRetryLimit: 591,
      loginReactiveTime: '2023-08-17T23:45:29.931Z',
      id: '63d68f9a42cb3e1970a3dadd'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Milan_Labadie20',
        'password':'QX5MVs6P3q3CSKK',
        'email':'Myrna.Hammes@hotmail.com',
        'name':'Dr. Sam VonRueden',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Meadows',
          'address1':'panel',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Myrna.Hammes@hotmail.com', });
