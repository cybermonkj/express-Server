...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Gina75',
      password: 'kfTrTnMHnsh2IKr',
      email: 'Samanta_Stiedemann@gmail.com',
      name: 'Mr. Rachel Lemke',
      shippingAddress: [
        {
          _id: false,
          pincode: 'maximize',
      ...
      userType: 275,
      mobileNo: '(225) 454-6654',
      resetPasswordLink: {},
      loginRetryLimit: 492,
      loginReactiveTime: '2023-04-20T07:44:24.657Z',
      id: '63d68f9a42cb3e1970a3da71'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Grayce55',
        'password':'fhVIV69vxqaaQ1W',
        'email':'Darron_Herman@yahoo.com',
        'name':'Nathan Bergnaum',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Checking',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Darron_Herman@yahoo.com', });
